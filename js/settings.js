...
function setCloak() { // applies only to premade cloaks
  ...
  switch (cloak) {
    case "search": // Google Search
      setTitle("Google");
      setFavicon("/favi/google.ico");
      location.reload();
      break;
    case "drive": // Google Drive
      setTitle("My Dive - Google Drive");
      setFavicon("/favi/google-drive-ico.ico");
      location.reload();
      break;
    case "classroom": // Google Classroom
      setTitle("Google Classroom");
      setFavicon("/favi/google-classroom.ico");
      location.reload();
      break;
    case "gmail": // Gmail
      setTitle("Gmail");
      setFavicon("/favi/gmail.ico");
      location.reload();
      break;
    case "word": // Word
      setTitle("Document.docx");
      setFavicon("/favi/word.ico");
      location.reload();
      break;
    case "powerpoint": // Powerpoint
      setTitle("Presentation.pptx");
      setFavicon("/favi/powerpoint.ico");
      location.reload();
      break;
    case "youtube": // YouTube 
      setTitle("YouTube");
      setFavicon("/favi/youtube.ico");
      location.reload();
      break;
    case "calendar": // Google Calendar
      setTitle("Google Calendar");
      setFavicon("/favi/google-calender.ico");
      location.reload();
      break;
    case "meets": // Google Meet
      setTitle("Google Meet");
      setFavicon("/favi/google-meet.ico");
      location.reload();
      break;
    case "canvas": // Canvas 
      setTitle("Canvas");
      setFavicon("/favi/canvas.ico");
      location.reload();
      break;
    case "zoom": // Zoom
      setTitle("Zoom");
      setFavicon("/favi/zoom.ico");
      location.reload();
      break;
    case "khan": // Khan Academy
      setTitle("Khan Academy"); 
      setFavicon("/favi/khan-academy.ico");
      location.reload();
      break;
  }
}
